...
(function (global) {
  ...
  var STORAGE_KEY = "complexQuestProgress";

  var BOOK_RECOMMEND = {
    title: "吉田武『虚数の情緒 ― 中学生からの全方位独学法』（東海大学出版会）",
  ...
  var STAGES = [
    ...
    { n: 3, file: "stage3.html", title: "ガウス平面 ― 数が平面になった", sub: "複素数は「点」である" },
    { n: 4, file: "stage4.html", title: "i を掛けると90度回る", sub: "掛け算の正体は回転だった" },
    { n: 5, file: "stage5.html", title: "長さと角度で表す ― 極形式", sub: "絶対値と偏角" },
    { n: 6, file: "stage6.html", title: "ド・モアブルの定理", sub: "回転をくり返すと円の上に正n角形" },
    { n: 7, file: "stage7.html", title: "e ― もうひとつの主役", sub: "成長の数と、曲がり続ける成長" },
    { n: 8, file: "stage8.html", title: "オイラーの等式", sub: "e^iπ + 1 = 0 ― 五つの数の出会い" }
  ];
